import { View, Text, Pressable, RefreshControl, StyleSheet, Alert, ActivityIndicator } from 'react-native';
...
const styles = StyleSheet.create({
    ...
    qualityBadgeText: { color: '#d8e3f2', fontSize: 10, fontWeight: '700' },
    info: {
        flex: 1,
        padding: 12,
