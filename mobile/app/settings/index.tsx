...
export default function SettingsScreen() {
    ...
    const checkUpdate = async () => {
        const versionInfo = await import('@/services/api').then(m => m.checkAppVersion());
        if (versionInfo) {
            ...
            if (versionInfo.version !== currentVersion) {
                ...
                // In a real app, we would open Linking.openURL(versionInfo.download_url)
                // For now just show alert or navigate to a webview
