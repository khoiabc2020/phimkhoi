            ...
            <div className="space-y-3 [contain:layout_paint]">
                {movies.slice(0, 5).map((movie: any) => (
                    <Link key={movie._id} href={`/phim/${movie.slug}`}
                        ...
                        {/* Poster */}
                        <div className="relative w-16 aspect-[2/3] rounded-lg overflow-hidden shrink-0 ring-1 ring-white/[0.08] group-hover:ring-[#E50914]/50 transition-all duration-200 shadow-md">
                            <Image
                        ...
                        <div className="flex-1 min-w-0 py-0.5 flex flex-col justify-center">
                            <h4 className="text-white text-xs font-semibold leading-tight mb-1 group-hover:text-[#E50914] transition-colors line-clamp-2" style={{ fontSize: '13px' }}>
                                {movie.name}
                            </h4>
