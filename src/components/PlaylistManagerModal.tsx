                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full bg-black/50 border border-white/10 rounded-lg px-4 py-3 text-white placeholder:text-white/20 focus:outline-none focus:border-[#E50914] focus:ring-1 focus:ring-[#E50914] transition-all"
                                autoFocus
                            />
                        ...
                        <div className="flex items-center gap-3 pt-4">
                            ...
                            <button
                                ...
                                className="flex-1 py-3 px-4 rounded-lg font-bold text-[#0a0a0a] bg-[#E50914] hover:brightness-110 transition-colors flex items-center justify-center disabled:opacity-50"
                            >
