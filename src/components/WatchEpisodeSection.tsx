        ...
        <div className="bg-[#07070b]/82 rounded-[10px] border border-white/[0.06] overflow-hidden mb-6 sm:mb-8 mt-4 mx-3 sm:mx-4 md:mx-0 shadow-[0_12px_28px_#00000066]">
            ...
            <div className="flex items-center justify-between gap-3 px-4 sm:px-6 py-4 sm:py-5 border-b border-white/[0.06] bg-[#09090d]">
                <div className="flex items-center gap-2">
                    <List className="w-[18px] h-[18px] text-[#E50914]" />
            ...
            <div className="px-3 sm:px-6 pt-3 sm:pt-5 pb-4 sm:pb-8">
                ...
                <div className="mb-4 sm:mb-6">
                    ...
                    >
                        ...
                        <span className="text-[13px] sm:text-[15px] font-bold text-white group-hover:text-[#E50914] transition-colors truncate max-w-[240px] sm:max-w-none">
                            {movieName}
                        </span>
                    </Link>
                </div>
                    ...
                    <div className="flex items-center gap-3 sm:gap-6 border-b border-white/[0.06] mb-3 sm:mb-5 overflow-x-auto no-scrollbar pb-1">
                        {activeLanguageGroups.map((lang) => {
                            ...
                            return (
                                ...
                                >
                                    <Icon className={cn("w-[14px] h-[14px] sm:w-[16px] sm:h-[16px]", isActive ? "text-[#E50914]" : "text-gray-400")} />
                                    {lang}
                                    {isActive && (
                                        <span className="absolute bottom-[-1px] left-0 right-0 h-[3px] rounded-t-full bg-[#E50914] shadow-[0_0_12px_#E5091499]" />
                                    )}
                                </button>
                            );
                        })}
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={cn(
                                                ...
                                                isServerActive
                                                    ? "bg-[#E50914] border-[#E50914] text-[#0a0a0a] shadow-[0_4px_14px_#E5091440] scale-105 transform"
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 mb-4 sm:mb-6">
                    <div className="flex items-center gap-3 sm:gap-4 flex-wrap">
                        ...
                        <div className="text-[13px] sm:text-[14px] text-gray-300">
                            Danh sách tập ( <span className="text-[#E4E4E5] font-bold">{episodes.length}</span> / <span className="text-[#E50914] font-bold">{episodes.length}</span> )
                        </div>
                        ...
                        {episodes.length > EPISODES_PER_CHUNK && (
                            <div className="relative">
                                <select
                                    className="appearance-none bg-[#0B0B10] border border-white/[0.10] text-gray-100 font-semibold text-[13px] rounded-lg pl-4 pr-10 py-2 focus:outline-none focus:border-[#E50914]/50 transition-colors cursor-pointer shadow-sm"
                                    value={currentChunk}
                    ...
                    <div className="flex items-center gap-3 shrink-0">
                        ...
                        <button
                            ...
                            className={cn(
                                ...
                                isCollapsed ? "bg-white/15" : "bg-white/30"
                            )}
                        >
                            <span
                                className={cn(
                ...
                {!isCollapsed ? (
                                ...
                                return (
                                    <Link
                                        ...
                                        className={cn(
                                            ...
                                            isActive
                                                ? "border-[#E50914]/70 ring-1 ring-[#E50914]/45 shadow-[0_0_18px_#E5091433]"
                                    ...
                                    >
                                        ...
                                        {isActive && (
                                            <div className="absolute top-2 right-2 px-2 py-0.5 rounded bg-[#E50914] text-[#0a0a0a] text-[10px] font-black uppercase shadow-sm">
                                                Đang xem
                                            </div>
                                        )}
                                    </Link>
                                ...
                                return (
                                    <Link
                                        ...
                                        className={cn(
                                            ...
                                            isActive
                                                ? "bg-[#E50914]/[0.15] border-[#E50914]/60 text-[#E50914] shadow-[0_0_16px_#E509141F]"
                    ...
                    <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-7 gap-2 sm:gap-3 max-h-[360px] sm:max-h-[440px] overflow-y-auto custom-scrollbar pr-1 sm:pr-2 [contain:layout_paint]">
                        {pageEpisodes.map((ep) => {
                            const isActive = ep.slug === currentEpisodeSlug;
                            const displayNum = getEpisodeNumber(ep.name)?.padStart(2, '0') || ep.name;
                            return (
