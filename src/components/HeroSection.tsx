...
function DesktopHero({ movies, active = true }: { movies: Movie[], active?: boolean }) {
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-y-0 left-0 right-0 z-[35] pointer-events-none flex items-center justify-between px-4 md:px-8 lg:pl-26 lg:pr-6 xl:pl-34 xl:pr-14">
                <button 
                    onClick={prev}
