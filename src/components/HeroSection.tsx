...
function MobileHero({
    ...
    const movie: any = movies[selectedIndex] ?? movies[0];
    ...
    return (
        <div className="relative w-full bg-transparent" style={{ contain: "layout paint" }}>
            <div className="flex flex-row touch-pan-y" style={{ contain: "layout" }}>
                <div className="relative flex-[0_0_100%] min-w-0 flex flex-col transition-opacity duration-300">
...
function DesktopHero({
    ...
    const scrollNext = () => {
        setSelectedIndex((selectedIndex + 1) % movies.length);
    };

    const scrollPrev = () => {
        setSelectedIndex((selectedIndex - 1 + movies.length) % movies.length);
    };

    return (
        <div className="relative w-full h-[55vh] lg:h-[70vh] xl:h-screen overflow-hidden" style={{ contain: "layout style paint" }}>
            <div className="absolute inset-0 h-full" style={{ contain: "layout" }}>
                <div className="flex h-full touch-pan-y" style={{ contain: "layout" }}>
                    <div className="relative flex-[0_0_100%] min-w-0 h-full bg-transparent overflow-hidden">
