...
const NAV_ITEMS = [
    {
        ...
        sub: "Xem chủ đề",
        href: "/phim-han",
        from: "rgba(37, 99, 235, 0.95)",
        to: "rgba(59, 130, 246, 0.85)",
    },
    {
        label: "Trung Quốc",
        sub: "Xem chủ đề",
        href: "/phim-trung",
        from: "rgba(13, 148, 136, 0.95)",
        to: "rgba(20, 184, 166, 0.85)",
    },
    {
        label: "Phim Ngắn",
        sub: "Xem chủ đề",
        href: "/the-loai/phim-ngan",
        from: "rgba(217, 119, 6, 0.95)",
        to: "rgba(245, 158, 11, 0.85)",
    },
    {
        label: "Thuyết Minh",
        sub: "Xem chủ đề",
        ...
        to: "rgba(139, 92, 246, 0.85)",
    },
    {
        label: "Phim Mỹ",
        sub: "Xem chủ đề",
        href: "/quoc-gia/my",
        from: "rgba(225, 29, 72, 0.95)",
        to: "rgba(244, 63, 94, 0.85)",
    },
    {
        label: "Thái Lan",
        sub: "Xem chủ đề",
        href: "/quoc-gia/thai-lan",
        from: "rgba(79, 70, 229, 0.95)",
        to: "rgba(99, 102, 241, 0.85)",
    },
];
