                ...
                art = new Artplayer({
                    ...
                    controls: [
                        // Skip back 10s
                        {
                            ...
                            html: `<div style="display:flex; align-items:center; justify-content:center; width:36px; height:36px; margin: 0; transition: opacity 0.2s;" onmouseover="this.style.opacity='0.7'" onmouseout="this.style.opacity='1'">
                                <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M3 11l-2 2 2 2M1 13h15a5 5 0 0 1 0 10H8" />
                                    <text x="12" y="15" font-size="7" font-family="sans-serif" font-weight="bold" fill="white" stroke="none">-10</text>
                                </svg>
                            </div>`,
                            tooltip: "Tua lùi 10s",
                        ...
                        // Skip forward 10s
                        {
                            ...
                            html: `<div style="display:flex; align-items:center; justify-content:center; width:36px; height:36px; margin: 0; transition: opacity 0.2s;" onmouseover="this.style.opacity='0.7'" onmouseout="this.style.opacity='1'">
                                <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M21 11l2 2-2 2M23 13H8a5 5 0 0 0 0 10h8" />
                                    <text x="12" y="15" font-size="7" font-family="sans-serif" font-weight="bold" fill="white" stroke="none">+10</text>
                                </svg>
                            </div>`,
