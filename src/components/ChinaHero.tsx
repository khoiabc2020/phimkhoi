...
const ASSETS_MAP: Record<string, MovieSlideAssets> = {
    "bach-nguyet-phan-tinh": {
        bg: "/images/china-hero/bach-nguyet-bg.webp?v=1.5",
        actor: "/images/china-hero/bach-nguyet-actor.webp?v=1.5",
        logo: "/images/china-hero/bach-nguyet-logo.webp?v=1.5",
    },
    "bui-hoa-hong": {
        bg: "/images/china-hero/bui-hoa-hong-bg.webp?v=1.5",
        actor: "/images/china-hero/bui-hoa-hong-actor.webp?v=1.5",
        logo: "/images/china-hero/bui-hoa-hong-logo.webp?v=1.5",
    },
    "dai-mong-quy-ly": {
        bg: "/images/china-hero/dai-mong-bg.webp?v=1.5",
        actor: "/images/china-hero/dai-mong-actor.webp?v=1.5",
        logo: "/images/china-hero/dai-mong-logo.webp?v=1.5",
    },
    "giang-ho-da-vu-thap-nien-dang": {
        bg: "/images/china-hero/giang-ho-bg.webp?v=1.5",
        actor: "/images/china-hero/giang-ho-actor.webp?v=1.5",
        logo: "/images/china-hero/giang-ho-logo.png?v=1.5",
    },
    "mac-nhan-tang-kieu": {
        bg: "/images/china-hero/mac-nhan-bg.webp?v=1.5",
        actor: "/images/china-hero/mac-nhan-actor.webp?v=1.5",
        logo: "/images/china-hero/mac-nhan-logo.webp?v=1.5",
    },
    "ngoc-minh-tra-cot": {
        bg: "/images/china-hero/ngoc-minh-bg.webp?v=1.5",
        actor: "/images/china-hero/ngoc-minh-actor.webp?v=1.5",
        logo: "/images/china-hero/ngoc-minh-logo.webp?v=1.5",
    },
    "con-ra-the-thong-gi-nua": {
        bg: "/images/china-hero/the-thong-bg.webp?v=1.5",
        actor: "/images/china-hero/the-thong-actor.webp?v=1.5",
        logo: "/images/china-hero/the-thong-logo.webp?v=1.5",
    },
    "truc-ngoc": {
        bg: "/images/china-hero/truc-ngoc-bg.webp?v=1.5",
        actor: "/images/china-hero/truc-ngoc-actor.webp?v=1.5",
        logo: "/images/china-hero/truc-ngoc-logo.webp?v=1.5",
    },
    "xin-chao-1983": {
        bg: "/images/china-hero/xin-chao-bg.webp?v=1.5",
        actor: "/images/china-hero/xin-chao-actor.webp?v=1.5",
        logo: "/images/china-hero/xin-chao-logo.webp?v=1.5",
    },
    "duong-cung-ky-an-thanh-vu-phong-minh": {
        bg: "/images/china-hero/tang-cung-bg.png?v=1.5",
        actor: "/images/china-hero/tang-cung-actor.png?v=1.5",
        logo: "/images/china-hero/tang-cung-logo.png?v=1.5",
    }
};
