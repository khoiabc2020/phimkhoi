...
export default function CommentSection({ movieId, movieSlug, episodeName }: CommentSectionProps) {
    ...
    return (
        <div className="bg-[#0b0b0b] p-4 md:p-6 rounded-lg border border-white/5 scroll-mt-24">
            ...
            {session ? (
                <form onSubmit={handleSubmit} className="mb-8">
                    <div className="bg-[#121212] rounded-lg border border-white/5 p-4 relative">
                ...
                <div className="bg-white/5 text-gray-400 p-4 rounded-lg mb-8 text-center border border-white/10 text-sm">
